...
::::::: Comment
This should mean that people behind firewalls with their own root certificate authorities are
still able to access remote git repos.
:::::::
...
1. Configuring extra options {% endcomment %}
...
<div>
<iframe type="text/html" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" src="https://www.youtube-nocookie.com/embed/339AEqk9c-8?modestbranding=1&playsinline=1&iv_load_policy=3&rel=0"></iframe>
</div>
...
<div>
<iframe type="text/html" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" src="https://www.youtube-nocookie.com/embed/9LQhwETCdwY?modestbranding=1&playsinline=1&iv_load_policy=3&rel=0"></iframe>
</div>
...
```{r, eval=FALSE}
install.packages(c("pbdR", "pbdML", "pbdMPI", "pbdMAT", "flexiblas", "parallel", "randomForest"))
```
